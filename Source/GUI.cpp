...
RGBA Menu::Settings::scroller{ 7, 84, 61, 255 };
...
void Menu::BANNER()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Banner\\" << file;
...
void Menu::ARROW()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Arrow\\" << file;
...
void Menu::LOGO()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Logo\\" << file;
...
void Menu::PLAYERINFO()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Infobox\\" << file;
...
void Menu::PLATE()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Plate\\" << file;
...
void Menu::NOTIFYICON()
{
	...
	std::ostringstream m_FilePath; m_FilePath << "C:\\Arctic\\Icons\\" << file;
...
float prevf;
float prevfff123;
float ScrollerSpeed = 0.005f; // here like 0.01f, it's slower //can i change the colour lilke transparent? of scroller? ye yes lol 
const auto animscroll = [](int* prev, const int cur) {
	if (prevf == NULL)
		prevf = *prev * 0.035f + 0.1768f;
	    prevfff123 = *prev * (Menu::Settings::optionCount - (Menu::Settings::currentOption - 11)) * 0.035f + 0.1768f;
	...
	if (Menu::Settings::currentOption <= Menu::Settings::maxVisOptions && Menu::Settings::optionCount <= Menu::Settings::maxVisOptions) {
		if (*prev != cur)
		{
			if (prevf < curf)
			{
				...
				Menu::Drawing::Rect(Menu::Settings::scroller, { Menu::Settings::menuX, prevf }, { 0.20f, 0.035f });
				if (prevf >= curf)
				{
					prevf = curf;
					*prev = cur;
		...
		Menu::Drawing::Rect(Menu::Settings::scroller, { Menu::Settings::menuX, (Menu::Settings::optionCount - (Menu::Settings::currentOption - 11)) * 0.035f + 0.1768f }, { 0.20f, 0.035f });
	}
};

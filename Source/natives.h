...
namespace PLAYER
{
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL fadeInOut);// 0xAD15F075A4DA0FDE 0xC552E06C
	//static void S_P_T(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL fadeInOut);// 0xAD15F075A4DA0FDE 0xC552E06C
	static Ped GET_PLAYER_PED(Player player) { return invoke<Ped>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	//static Player GET_PLAYER_PED_ID(Player player) { return invoke<Ped>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	...
	static Ped GET_ONLINE_PLAYER_ID(Player player) { return invoke<Ped>(0x50FAC3A3E030A6E1, player); } // 0x50FAC3A3E030A6E1 0x6AC64990
	...
	static const char* GET_ONLINE_NAME(Player player) { return invoke<const char*>(0x6D0DE6A7B5DA71F8, player); } // 0x6D0DE6A7B5DA71F8 0x406B4B20
...
namespace ENTITY
{
	static void SET_ENTITY_COLLISION_(Entity entity, BOOL p1) { invoke<Void>(0x9EBC85ED0FFFE51C, entity, p1); } // 0x9EBC85ED0FFFE51C
	...
	static Vector3 G_C_O_E(Entity entity, BOOL alive) { return invoke<Vector3>(0x3FEF770D40960D5A, entity, alive); }
	static float G_C_C_O_E(Entity entity, BOOL alive) { return invoke<float>(0x3FEF770D40960D5A, entity, alive); }
	...
	static void SET_ENTITY_COORDS_VECTOR3(Entity entity, Vector3 targetcoords, BOOL xAxis, BOOL yAxis, BOOL zAxis, BOOL clearArea) { invoke<Void>(0x06843DA7060A026B, entity, targetcoords, clearArea); } // 0x06843DA7060A026B 0xDF70B41B
...
namespace PED
{
	...
	static Ped LEAKEAE_AEAJEJAEKAJE_EE_E(int pedType, Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); }
	...
	static void S_P_M_A(Ped ped, int amount) { invoke<Void>(0xA9C8960E8684C1B5, ped, amount); } // 0xA9C8960E8684C1B5 0x40D90BF2
	...
	static void SET_DISABLE_WEAPONS(Ped ped, BOOL toggle) { invoke<Void>(0xDF1AF8B5D56542FA, ped, toggle); } // 0xDF1AF8B5D56542FA 0xAC9BBA23
	...
	static void R_C_T_P(Ped ped, BOOL p1) { invoke<Void>(0xC8A9481A01E63C28, ped, p1); }
...
namespace VEHICLE
{
	...
	static Vehicle C_O_P(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); }
	...
	static void GET_VEHICLE_COLOURS_2(Vehicle vehicle, int colorPrimary, int colorSecondary) { invoke<Void>(0xA19435F193E081AC, vehicle, colorPrimary, colorSecondary); } // 0xA19435F193E081AC 0x40D82D88
	...
	static void SET_VEHICLE_ENGINE_ON(Vehicle veh, BOOL engineState, BOOL p3) { invoke<Void>(0x2497C4717C8B881E, veh, engineState, p3); } // 0x7FBC86F1
	static void SET_VEHICLE_ENGINE_ON1(Vehicle vehicle, BOOL value, BOOL instantly, BOOL otherwise) { invoke<Void>(0x2497C4717C8B881E, vehicle, value, instantly, otherwise); } // 0x2497C4717C8B881E 0x7FBC86F1
...
namespace OBJECT
{
	...
	static Pickup A_P_O_P(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, p4, value, modelHash, returnHandle, p8); }
	...
	static void CREATE_MONEY_PICKUPS(float x, float y, float z, int value, int amount, Hash model) { invoke<Void>(0x0589B5E791CE9B2B, x, y, z, value, amount, model); } // 0x0589B5E791CE9B2B 
	static void M_P_O_P_M(float x, float y, float z, int value, int amount, Hash model) { invoke<Void>(0x0589B5E791CE9B2B, x, y, z, value, amount, model); } 
...
namespace GAMEPLAY
{
	static BOOL _GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float* groundZ) { return invoke<BOOL>(0xC906A7DAB05C8D2B, x, y, z, groundZ); } // 0xC906A7DAB05C8D2B 0xA1BFD5E0
	...
	static void S_W_N_P(char* weatherType) { invoke<Void>(0xED712CA327900C8A, weatherType); } // 0xED712CA327900C8A 0xC869FE97
	...
	static void SET_BIT2(int* var, int bit) { invoke<Void>(0x4EFE7E6B, var, bit); } // 0x4EFE7E6B
...
namespace WEAPON
{
	static BOOL W_I(Ped ped, Vector3* coords) { return invoke<BOOL>(0x6C4D0409BA1A2BC2, ped, coords); }
	...
	static void GIVE_DELAYED_WEAPON_TO_PED2(Ped ped, Hash weaponHash, int time, BOOL equipNow) { invoke<Void>(0xB282DC6EBD803C75, ped, weaponHash, time, equipNow); } // 0xB282DC6EBD803C75 0x5868D20D
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int eventGroup, uint64_t* args, int argCount, int bit) { invoke<Void>(0x5AE99C571D5BBE5D, eventGroup, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
	static void T_S_E(int p0, Any* argsStruct, int argsStructCount, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructCount, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
	static void T_SS_E(int p0, int* argsStruct, int argsStructCount, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructCount, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static int __SET_NOTIFICATION_MESSAGE(char* picName1, char* picName2, BOOL flash, int iconType, char* sender, char* subject) { return invoke<Any>(0xE7E3C98B, picName1, picName2, flash, iconType, sender, subject); } // 0xE7E3C98B
	...
	//static int _SET_CLAN_TAG(char* picName1, char* picName2, BOOL flash, int iconType, string sender, string subject, float duration, char* clanTag) { return invoke<int>(0x5CBF7BADE20DB93E, picName1, picName2, flash, iconType, sender, subject, duration, clanTag); } // 0x5CBF7BADE20DB93E 0x3E807FE3
	...
	static void SET_STRING_TEXT(std::string text) { invoke<Void>(0x6C188BE134E074AA, text); } // 0x6C188BE134E074AA 0x27A244D8
...
namespace GRAPHICS
{
	...
	static void R_S_T_D(std::string textureDict, BOOL p1) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, p1); } // 0xDFA2EF8E04127DD5 0x4C9B035F
	...
	static BOOL H_S_T_D_L(std::string textureDict) { return invoke<BOOL>(0x0145F696AAAAD2E4, textureDict); } // 0x0145F696AAAAD2E4 0x3F436EEF
	...
	static void DRAW_VEHICLE_SPRITE(std::string textureDict, std::string textureName, float screenX, float screenY, float width, float height, float heading, int red, int green, int blue, int alpha) { invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue, alpha); } // 0xE7FFAE5EBF23D890 0x1FEC16B0
	...
	static Vector3 G_T_R(std::string textureDict, std::string textureName) { return invoke<Vector3>(0x35736EE65BD00C11, textureDict, textureName); } // 0x35736EE65BD00C11 0x096DAA4D
...
namespace STATS
{
	...
	static BOOL S_I_S(Hash statName, int value, BOOL save) { return invoke<BOOL>(0xB3271D7AB655B441, statName, value, save); }
	static BOOL I_S_S_T(Hash statName, int value, BOOL save) { return invoke<BOOL>(0xB3271D7AB655B441, statName, value, save); }
...
namespace FIRE
{
	static void ADD_EXP_123(float x, float y, float z, int type, float damage, bool audible, bool invis, float shake, bool nodmg) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, type, damage, audible, invis, shake, nodmg); } // 0xE3AD2BDBAEE269AC 0x10AF5258
	...
	static void E_P_X(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); }
...
namespace NETWORK
{
	static int NETWORK_CREATE_SYNCHRONISED_SCENE2(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0x7CD6BC4C2BBDD526, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0x7CD6BC4C2BBDD526 0xB06FE3FE
	...
	static BOOL SEND_NETWORK_TEXT_MESSAGE(char* message, int* networkHandle) { return invoke<BOOL>(0x3A214F2EC889B100, message, networkHandle); } // 0x3A214F2EC889B100 0xAFFEA720
	...
	static BOOL REQUEST_C_O_P(Entity entity) { return invoke<BOOL>(0xB69317BF5E782347, entity); } // 0xB69317BF5E782347 0xA05FEBD7
	static BOOL N_R_C_O_E(Entity entity) { return invoke<BOOL>(0xB69317BF5E782347, entity); } // 0xB69317BF5E782347 0xA05FEBD7
	...
	static BOOL N_H_C_O_E(Entity entity) { return invoke<BOOL>(0x01BF60A500E28887, entity); } // 0x01BF60A500E28887 0x005FD797
	...
	static void NETWORK_HANDLE_ONLINE_PLAYER(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, networkHandle, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	static void N_H_F_P(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, networkHandle, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	static void NETWORK_HANDLE_FROM_PLAYER_UPD(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, networkHandle, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	static void _NETWORK_HANDLE__PLAYER(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, networkHandle, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	...
	static void SPECTATE(BOOL toggle, Ped playerPed) { invoke<Void>(0x423DE3854BB50894, toggle, playerPed); } // 0x423DE3854BB50894 0x5C4C8458
	...
	static int N_C_S_S(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0x7CD6BC4C2BBDD526, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0x7CD6BC4C2BBDD526 0xB06FE3FE
...
namespace ONLINE
{
	static Ped PUT_ON_HANDCUFFS(Ped ped, BOOL toggle) { return invoke<Ped>(0xDF1AF8B5D56542FA, ped); } // DF1AF8B5D56542FA AC9BBA23
	static Ped GIVE_PED_HELMET(Ped ped, BOOL cannotRemove, int helmetFlag, int textureIndex) { return invoke<Ped>(0x54C7C4A94367717E, ped); } // 0x54C7C4A94367717E 0x1862A461
}
